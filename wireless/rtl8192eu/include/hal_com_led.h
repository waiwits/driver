...
typedef	enum _LED_STATE {
	...
	LED_BLINK_TXRX              = 9,
	LED_BLINK_WPS               = 10,  // LED is blinking during WPS communication
...
VOID LedControlPCIE(IN PADAPTER Adapter, IN LED_CTL_MODE LedAction);
VOID gen_RefreshLedState(IN PADAPTER Adapter);
...
VOID LedControlUSB(IN PADAPTER Adapter, IN LED_CTL_MODE LedAction);
...
VOID LedControlSDIO(IN PADAPTER Adapter, IN LED_CTL_MODE LedAction);
#endif
...
void InitLed(_adapter *padapter, PLED_DATA pLed, LED_PIN LedPin);

...
typedef struct hal_com_data {
	...
	u8 TxPwrByRateTable;
	u8 TxPwrByRateBand;
	u32 TxPwrByRateOffset[TX_PWR_BY_RATE_NUM_BAND][TX_PWR_BY_RATE_NUM_RF][TX_PWR_BY_RATE_NUM_RF][TX_PWR_BY_RATE_NUM_SECTION];
	//---------------------------------------------------------------------------------//
	...
	u8 TxPwrLimit_2_4G[MAX_REGULATION_NUM][MAX_2_4G_BANDWITH_NUM][MAX_RATE_SECTION_NUM][MAX_2_4G_CHANNEL_NUM][MAX_RF_PATH_NUM];

	// Power Limit Table for 5G
	u8 TxPwrLimit_5G[MAX_REGULATION_NUM][MAX_5G_BANDWITH_NUM][MAX_RATE_SECTION_NUM][MAX_5G_CHANNEL_NUM][MAX_RF_PATH_NUM];


	// Store the original power by rate value of the base of each rate section of rf path A & B
	u8 TxPwrByRateBase2_4G[TX_PWR_BY_RATE_NUM_RF][TX_PWR_BY_RATE_NUM_RF][MAX_BASE_NUM_IN_PHY_REG_PG_2_4G];

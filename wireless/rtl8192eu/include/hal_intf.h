...
#define	IS_HARDWARE_TYPE_8192C(_Adapter)(IS_HARDWARE_TYPE_8192CE(_Adapter) || IS_HARDWARE_TYPE_8192CU(_Adapter))
...
#define	IS_HARDWARE_TYPE_8192D(_Adapter)(IS_HARDWARE_TYPE_8192DE(_Adapter) || IS_HARDWARE_TYPE_8192DU(_Adapter))
...
#define	IS_HARDWARE_TYPE_8723A(_Adapter)(IS_HARDWARE_TYPE_8723AE(_Adapter) || IS_HARDWARE_TYPE_8723AU(_Adapter) || IS_HARDWARE_TYPE_8723AS(_Adapter))
...
#define	IS_HARDWARE_TYPE_8188E(_Adapter)(IS_HARDWARE_TYPE_8188EE(_Adapter) || IS_HARDWARE_TYPE_8188EU(_Adapter) || IS_HARDWARE_TYPE_8188ES(_Adapter))

#define IS_HARDWARE_TYPE_OLDER_THAN_8812A(_Adapter)(IS_HARDWARE_TYPE_8192D(_Adapter) || IS_HARDWARE_TYPE_8192C(_Adapter) \
...
#define IS_HARDWARE_TYPE_8812(_Adapter)(IS_HARDWARE_TYPE_8812E(_Adapter) || IS_HARDWARE_TYPE_8812AU(_Adapter))
...
#define IS_HARDWARE_TYPE_8821U(_Adapter)(((PADAPTER)_Adapter)->HardwareType==HARDWARE_TYPE_RTL8821U || ((PADAPTER)_Adapter)->HardwareType == HARDWARE_TYPE_RTL8811AU)
#define IS_HARDWARE_TYPE_8821S(_Adapter)(((PADAPTER)_Adapter)->HardwareType==HARDWARE_TYPE_RTL8821S)
#define IS_HARDWARE_TYPE_8821(_Adapter)(IS_HARDWARE_TYPE_8821E(_Adapter) || IS_HARDWARE_TYPE_8821U(_Adapter)|| IS_HARDWARE_TYPE_8821S(_Adapter))

#define IS_HARDWARE_TYPE_JAGUAR(_Adapter)(IS_HARDWARE_TYPE_8812(_Adapter) || IS_HARDWARE_TYPE_8821(_Adapter))
...
#define IS_HARDWARE_TYPE_8192E(_Adapter)(IS_HARDWARE_TYPE_8192EE(_Adapter) \
     || IS_HARDWARE_TYPE_8192EU(_Adapter) ||IS_HARDWARE_TYPE_8192ES(_Adapter))
...
#define IS_HARDWARE_TYPE_8723B(_Adapter)(IS_HARDWARE_TYPE_8723BE(_Adapter) || IS_HARDWARE_TYPE_8723BU(_Adapter) || IS_HARDWARE_TYPE_8723BS(_Adapter))

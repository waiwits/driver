...
VOID PHY_RFShadowWrite(IN PADAPTER Adapter, IN u8 eRFPath, IN u32 Offset, IN u32 Data);
BOOLEAN PHY_RFShadowCompare(IN PADAPTER Adapter, IN u8 eRFPath, IN u32 Offset);
...
VOID PHY_RFShadowCompareFlagSet(IN PADAPTER Adapter, IN u8 eRFPath, IN u32 Offset, IN u8 Type);
VOID PHY_RFShadowRecorverFlagSet(IN PADAPTER Adapter, IN u8 eRFPath, IN u32 Offset, IN u8 Type);

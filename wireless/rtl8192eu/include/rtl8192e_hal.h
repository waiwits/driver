...
#define TX_PAGE_BOUNDARY_8192E                       (TX_TOTAL_PAGE_NUMBER_8192E + 1)  // 0xF4,Reserved 12 pages for BCN/PS-POLL..
...
VOID _InitBeaconMaxError_8192E(IN PADAPTER Adapter, IN BOOLEAN InfraMode);
...
u8 SetHalDefVar8192E(IN PADAPTER Adapter, IN HAL_DEF_VARIABLE eVariable, IN PVOID pValue);
u8 GetHalDefVar8192E(IN PADAPTER Adapter, IN HAL_DEF_VARIABLE eVariable, IN PVOID pValue);

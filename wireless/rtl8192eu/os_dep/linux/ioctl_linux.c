...
static int rtw_mp_efuse_get(struct net_device *dev, struct iw_request_info *info, union iwreq_data *wdata, char *extra)
{
	PADAPTER padapter = rtw_netdev_priv(dev);
	...
	u16 i = 0, j = 0, k = 0, mapLen = 0, addr = 0, cnts = 0;
...
//			DBG_871X("\t");
			...
			for (k = j; k < 16; k++)
			{
//				DBG_871X("%02X ", data[i + k]);
				sprintf(extra, "%s%02X ", extra, PROMContent[i + k]);
			}
//			DBG_871X("\n");
			sprintf(extra,"%s\n",extra);
		}
...
//			DBG_871X("\t");
			...
			{
//				DBG_871X("%02X ", data[i + k]);
				sprintf(extra, "%s%02X ", extra, pEfuseHal->fakeEfuseInitMap[i + k]);
			}
//			DBG_871X("\n");
			sprintf(extra,"%s\n",extra);
		}
...
//			DBG_871X("\t");
			...
			for (k = j; k < 16; k++)
			{
//				DBG_871X("%02X ", pEfuseHal->BTEfuseInitMap[i + k]);
				sprintf(extra, "%s%02X ", extra, pEfuseHal->BTEfuseInitMap[i + k]);
			}
//			DBG_871X("\n");
			sprintf(extra, "%s\n", extra);
		}
...
//			DBG_871X("\t");
			...
			for (k = j; k < 16; k++)
			{
//				DBG_871X("%02X ", pEfuseHal->fakeBTEfuseModifiedMap[i + k]);
				sprintf(extra, "%s%02X ", extra, pEfuseHal->fakeBTEfuseModifiedMap[i + k]);
			}
//			DBG_871X("\n");
			sprintf(extra, "%s\n", extra);
		}
...
//			DBG_871X("\t");
			...
			for (k = j; k < 16; k++)
			{
//				DBG_871X("%02X ", pEfuseHal->fakeEfuseModifiedMap[i + k]);
				sprintf(extra, "%s %02X", extra, pEfuseHal->fakeEfuseModifiedMap[i + k]);
			}
//			DBG_871X("\n");
			sprintf(extra, "%s\n", extra);
		}
...
static int rtw_mp_efuse_set(struct net_device *dev, struct iw_request_info *info, union iwreq_data *wdata, char *extra)
{
	struct iw_point *wrqu;
	PADAPTER padapter;
	struct pwrctrl_priv *pwrctrlpriv ;
